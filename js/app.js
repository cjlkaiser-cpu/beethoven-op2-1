...
async function loadPasaje(index) {
    ...
    // Segunda imagen anotada (opcional)
    const c2 = document.getElementById('manuscript2Container');
    const img2 = document.getElementById('manuscriptImg2');
    if (pasaje.imagen2) {
        img2.src = pasaje.imagen2;
    ...
    // Canvas: si la imagen ya está cacheada, sincronizar inmediatamente
